import { HttpCheckError, HttpCheckResult, HttpErrorType, HttpTimingMetrics } from "@app/kafka-topics";
            ...
            const req = client.request(
                ...
                (res) => {
                    ...
                    res.on('end', () => {
                        ...
                        const connectionTime = timings.tcp_end || timings.tcp_beginning_start;

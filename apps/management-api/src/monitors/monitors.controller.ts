...
export class MonitorsController {
  ...
  @Get(':id')
  @UseGuards(TeamMemberGuard)
  findOne(@Param('projectId',ParseUUIDPipe) projectId: string, @Param('id',ParseUUIDPipe) id: string) {
    return this.monitorsService.findOne(projectId, id);
  }

  @Patch(':id')
  @UseGuards(TeamMemberGuard)
  update(@Param('projectId',ParseUUIDPipe) projectId: string, @Param('id',ParseUUIDPipe) id: string, @Body() updateMonitorDto: UpdateMonitorDto) {
    return this.monitorsService.update(projectId, id, updateMonitorDto);
  }

  @Delete(':id')
  @UseGuards(TeamMemberGuard)
  remove(@Param('projectId',ParseUUIDPipe) projectId: string, @Param('id',ParseUUIDPipe) id: string) {

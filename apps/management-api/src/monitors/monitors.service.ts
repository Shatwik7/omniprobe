...
export class MonitorsService {
  ...
  async update(projectId: string,monitorId:string, updateMonitorDto: UpdateMonitorDto) {
  ...
  async remove(projectId: string,monitorId:string):Promise<boolean> {
    const del=await  this.monitorRepository.delete({id:monitorId, project:{id:projectId}});
